        ...
        return (
            <NavigationContainer>
                <Stack.Navigator>
                    ...
                    <Stack.Screen options={{ headerStyle: { backgroundColor: 'orange' }, headerTitle: () => <CustomHeader textHeader="اماده سازی تصاویر" /> }} name="img" initialParams={{ setIsLogin: setIsLogin, SERVERINFO: SERVERINFO }} component={Img} />
