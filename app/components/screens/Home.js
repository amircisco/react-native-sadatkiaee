        ...
        return (
            <NavigationContainer>
                <Stack.Navigator>
                    ...
                    <Stack.Screen options={{ headerStyle: { backgroundColor: 'orange' }, headerTitle: () => <CustomHeader textHeader="آماده سازی تصاویر" /> }} name="img" initialParams={{ setIsLogin: setIsLogin, SERVERINFO: SERVERINFO }} component={Img} />
